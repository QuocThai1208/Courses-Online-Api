from courses.models import Category, Course, User, UserCourse, Forum, Comment, Chapter, Lesson, Document, LessonProgress, CourseProgress, LessonProgressStatus, Topic
    ...
    def get_last_comment(self, obj):
        ...
        if last_comment:
            return {
                ...
                'content': last_comment.content[:100] + '...' if len(last_comment.content) > 100 else last_comment.content,
...
class LecturerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'first_name', 'last_name', 'avatar', 'address', 'introduce', 'phone', 'date_joined', 'userRole', 'is_active']
...
class LessonDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lesson
        fields = ['id', 'chapter', 'name', 'description', 'type', 'video_url', 'duration', 'is_published', 'active', 'created_at', 'updated_at', 'documents']
...
class ChapterDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chapter
        fields = ['id', 'course', 'name', 'description', 'is_published', 'active', 'created_at', 'updated_at', 'lessons']
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['id', 'name', 'description', 'price', 'level', 'duration', 'thumbnail_url', 'learning_outcomes', 'requirements', 'video_url', 'lecturer', 'students_count', 'chapters']
