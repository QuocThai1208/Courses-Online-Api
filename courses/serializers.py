...
class UserRegistrationSerializer(BaseSerializer):
    ...
    class Meta:
        ...
        fields = ('username', 'password', 'confirm_password', 'email',
                  'first_name', 'last_name', 'avatar', 'address', 'phone', 'userRole')
...
class UserUpdateSerializer(BaseSerializer):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'username', 'email', 'avatar', 'address', 'password', 'phone')
...
class UserSerializer(BaseSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'username', 'email', 'first_name', 'last_name',
                  'avatar', 'address', 'phone', 'date_joined', 'userRole')
